...
func TestGroupSubscribers(t *testing.T) {
	...
	sessions := []model.RunningSession{sess1, sess2, sess3, sess4, sess5, sess6}
	db.Create(&ungrouped)
	db.Create(&sessions)
